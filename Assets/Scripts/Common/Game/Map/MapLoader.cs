...
public class MapLoader : MonoBehaviour
{
    ...
    /// <summary>
    /// 현재 MapManager의 방 데이터를 JSON 문자열로 저장합니다.
    /// </summary>
    ...
    /// <summary>
    /// JSON 문자열로 저장된 맵 데이터를 불러와서 맵을 재생성합니다.
    /// 기존 맵은 MapManager의 ResetMap()을 호출해 초기화합니다.
    /// </summary>
    public void LoadMapDataFromJson(string json)
    {
        ...
        {
            Debug.LogError("맵 데이터를 로드하는 데 실패했습니다. JSON 형식이 올바르지 않습니다.");
            return;
        }
